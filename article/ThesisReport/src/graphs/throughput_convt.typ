...
#canvas({
  ...
  plot.plot(size:(4,4),
    ...
    // legend:"north",
    {
      ...
      plot.add(data1,label:[#text(size:0.7em)[Transpose Convolution]],style:style1)
      plot.add(data2,label:[#text(size:0.7em)[Transpose DepthWise Convolution]],style:style2)
