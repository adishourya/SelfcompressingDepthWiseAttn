...
class compressKernels(manim.Scene):
    def construct(self):
        title = manim.Text("Quick Example: Reducing Bit Depth of Conv Weights", **font_style)
        title.to_edge()
        self.play(manim.Write(title), runtime=0.1)
        ...
        img_label2 = manim.Text("Pretend we are modelling to detect bricks in a wall", **font_style)
        img_label.next_to(img, manim.DOWN)
        img_label2.next_to(img_label, manim.DOWN)
        img_g = manim.Group(img, img_label)
        
        # add image to screen
        self.play(manim.FadeIn(img_g),runtime=0.5)
        self.play(manim.FadeIn(img_label2),runtime=0.4)
        self.play(manim.FadeOut(img_label2),runtime=0.1)
        
        # move the image to write
        self.play(manim.ScaleInPlace(img_g, 0.5),runtime=0.1)
        self.play(img_g.animate.to_edge(manim.LEFT),runtime=0.1)
        ...
        self.play(manim.FadeIn(kernels_g),runtime=0.5)
        self.play(kernels_g.animate.shift(manim.UP * 1.5),runtime=0.5)
        self.wait(0.4)
        ...
        self.play(manim.Transform(commentary1,commentary2),runtime=0.5)

        self.play(manim.FadeIn(faint_title),run_time=0.1)
        self.play(manim.FadeIn(horizontal_title),run_time=0.1)
        self.play(manim.FadeIn(diagonal_title),run_time=0.1)
        self.wait(0.1)
        ...
        self.play(manim.Transform(commentary1,commentary3),runtime=0.1)
        self.play(manim.FadeIn(from_kernels_g),runtime=0.1)
        self.play(from_kernels_g.animate.shift(manim.DOWN * 2),runtime=0.1)
        self.wait(0.1)
        ...
        self.play(manim.Transform(commentary1,commentary4),runtime=0.1)
        self.play(manim.Flash(kernel2,color=manim.GREEN), manim.Indicate(horizontal_title,color=manim.GREEN),runtime=0.2)
        self.play(manim.Transform(horizontal_title,horizontal_tile_update),runtime=0.1)
        self.wait(0.4)
        self.play(manim.Flash(kernel3,color=manim.BLUE), manim.Indicate(diagonal_title,color=manim.BLUE),runtime=0.2)
        self.play(manim.Transform(diagonal_title,diagonal_title_update),runtime=0.1)
        self.wait(0.4)

        # forget the kernel
        commentary5 = manim.Text("And might reduce Bit Depth for other Conv kernels",**font_style).to_edge(manim.UP).scale(0.6)
        self.play(manim.Transform(commentary1,commentary5),runtime=0.1)
        self.play(manim.Wiggle(faint_title),runtime=0.1)
        self.play(manim.Transform(faint_title,faint_title_update),runtime=0.1)
        self.wait(0.4)

        commentary6 = manim.Text("If the bit depth is reduced to zero, the entire kernel will be pruned.",**font_style).to_edge(manim.UP).scale(0.6)
        self.play(manim.Transform(commentary1,commentary6),runtime=0.1)
        self.play(manim.Indicate(kernel1,color=manim.GRAY_BROWN), manim.Indicate(from_kernel1,color=manim.GRAY_BROWN),runtime=0.3)
        self.play(manim.FadeOut(kernel1), manim.FadeOut(from_kernel1),runtime=0.1)

        self.wait(2)


if __name__ == "__main__":
    os.system("manim -qh --resolution 1920,1080 tying_conv1.py compressKernels")
